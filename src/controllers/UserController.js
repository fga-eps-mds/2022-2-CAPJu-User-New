...
class UserController {
    ...
    async login(req, res) {
        try {
		    ...
		    return res.status(404).json({message: "Senha ou usuário incorretos"});
	    }
        } catch (error) {
            console.log(error);
    ...
    async store(req, res ) {
        ...
        try {
            ...
            return res.status(500).json({error, mensagem: "Usuário não cadastrado!"});
        }
    }
    ...
    async updateUser(req, res) {
        try {
            ...
            console.log(error);
            return res.status(500).json({ error, message: "Usuário não atualizado!" });
        }
    }
    ...
    async editPassword(req, res) {
        try {
            ...
            console.log(error);
            return res.status(500).json({ error, message: "Erro a atualizar usuário " });
        }
    }
    ...
    async acceptRequest(req, res) {
        try {
            ...
            return res.status(500).json({error, mensagem: "Não foi aceitar o novo usuário"});
        }
    }
    ...
    async deleteRequest(req, res) {
        try {
            ...
            console.log("error", error);
            return res.status(500).json({error, mensagem: "Não foi possivel deletar o usuário"});
        }
    }
